  ...
  public function __construct(){
    ...
    public function update(UpdateBlogRequest $request, Post $blog)
    {
        if(Auth::user()->cant('update',$blog))
          return redirect()->route('blog.index')->with('status', 'You dont have permision to edit');
    ...
    public function destroy(Post $blog)
    {
      if(Auth::user()->cant('delete',$blog))
        return redirect()->route('blog.index')->with('status', 'You dont have permision to delete');
